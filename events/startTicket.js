        ...
        if (interaction.isButton() && interaction.customId === "close_ticket") {
            ...
            if (option === "create_call") {
                ...
                try {
                    response = await sourcebin.create({
                        ...
                        description: `Copyright © Medusa's Community`,
                        files: [
                            {
                                content: output,
                                language: 'text',
                ...
                interaction.update({
                    embeds: [
                        new Discord.EmbedBuilder()
                            ...
                            .addFields(
                                { name: '⭐ Chave pix', value: `\`\`\`${config.vendas.pix}\`\`\`` },
                                { name: '🧑 Nome', value: `\`\`\`${config.vendas.name}\`\`\`` }
                            )
                    ],
                    components: [],
                    ephemeral: true
            ...
            await interaction.update({
                embeds: [
                    new Discord.EmbedBuilder()
                        .setColor(config.embeds_color.embed_invisible)
                        .setDescription(`<a:loading:1080556589909540964> | Apagando ticket em 5 segundos...`)
                ],
                components: [],
            })
            ...
            for (let i = 4; i >= 1; i--) {
                ...
                interaction.editReply({
                    embeds: [
                        new Discord.EmbedBuilder()
                            .setColor(config.embeds_color.embed_invisible)
                            .setDescription(`<a:loading:1080556589909540964> | Apagando ticket em ${i} segundos...`)
                    ],
                    components: [],
                });
            }
